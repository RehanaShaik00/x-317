...
Scenario: Login and Set Low Temp
...
And I set the Temperature to -5.0 in Low Lim Air Section
...
Then I verify the Description as --- Low Temp Alarm in Information window of Active Alarm
...
Then I verify the Description as --- Low Temp Alarm in Information window of Acknowledge Alarm
