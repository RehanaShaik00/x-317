...
And('I set the Temperature to -5.0 in Low Lim Air Section', function() {
    cy.wait(5000)//wait for page to load
    Dashboard.getSelectLowTemp().dblclick()//select high temp section
    Dashboard.getEditBox().type('-5.0')//set high temp as 25
...
Then('I verify the Description as --- Low Temp Alarm in Information window of Active Alarm', function() {
...
Then('I verify the Description as --- Low Temp Alarm in Information window of Acknowledge Alarm', function() {
